...
import { ProjcteFindManyArgs } from "../../projcte/base/ProjcteFindManyArgs";
import { Projcte } from "../../projcte/base/Projcte";
...
export class UserControllerBase {
  ...
  async findManyProjctes(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Projcte[]> {
    const query = plainToClass(ProjcteFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findProjctes(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  @common.Post("/:id/projctes")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createProjctes(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Patch("/:id/projctes")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateProjctes(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/projctes")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteProjctes(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
